...
let private bs  = "This is a string"B
...
type ``Execute SET GET`` () =
    ...
    static member ``set get cmds, roundtrip``() =
        ...
        let expected =  hval |> RespUtils.MakeBulkStr
